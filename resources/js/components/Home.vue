	...
	<div>
	  ...
	  <div class="carousel carousel-slider center">
	  	<div v-for="elem in images">
		    <div class="carousel-item white-text" :style="{ backgroundImage: 'url(' + elem.img + ')' }">
		      <h1 class="panel">{{  elem.text }}</h1>
		      <p class="white-text">{{ elem.desc }}</p>
		    </div>
		  </div>
		</div>
		<!-- end carousel -->
		...
		<section>
		    ...
		    <div class="parallax"><img src="/img/paralax1.jpg"></div>
		  </div>
		</section>
		<!-- end parallax 1 -->
...
<script>
  ...
  export default {
    ...
    mounted () {
      //Carousel
	    var elem = $('.carousel.carousel-slider').carousel({
	    	fullWidth: true,
				padding: 200,
				indicators: true
    ...
    data () {
      return {
        images: [
          {
            img: '/img/gold.jpg',
            text: 'Logam Mulia Emas',
            desc: 'Merupakan salah satu produk investasi yang cukup menjanjikan'
          },
          {
            img: '/img/stmik.jpg',
